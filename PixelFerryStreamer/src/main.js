...
function startServer() {
  ...
  web.get('/healthz', (_request, response) => response.json({
    backend: 'streamer', displayID: Number(options.displayId), width: options.width, height: options.height,
  ...
  server.listen(options.port, '0.0.0.0', () => console.log(`PixelFerry viewer: http://127.0.0.1:${options.port}/`));
}
